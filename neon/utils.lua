...
function neon.class(classname, super)
...
function neon.iskindof(obj, classname)
    local t = type(obj)
    local mt
    if t == "table" then
        mt = getmetatable(obj)
...
function neon.import(moduleName, currentModuleName)
...
function neon.handler(obj, method)
    return function(...)
        return method(obj, ...)
    end
end
